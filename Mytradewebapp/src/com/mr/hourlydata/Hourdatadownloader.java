...
public class Hourdatadownloader {

	public int interval = 0;
	public int dayrange = 0;
	public Hourdatadownloader(String p) {
	...
	public StockOtherTechnicals getstochdata(String stocksymbol) throws MalformedURLException
	{
		...
		URL tdlink = new URL("https://www.google.com/finance/getprices?q="+stocksymbol+"&x=NSE&i=300&p="+this.dayrange+"d&f=d,o,h,l,c,v");
		...
		try {
			...
			System.out.println(stocksymbol+"fired conn");
...
return new float[] { trenddown, trendup,trend };
	...
	private ArrayList<TickData> getconvertedtick(ArrayList<TickData> tickhash, int interval) {
		...
		System.out.println("entered coverting area");
